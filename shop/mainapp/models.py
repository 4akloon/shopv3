...
class Cart(models.Model):
    ...
    status = models.ForeignKey(CartStatus, verbose_name='Статус', on_delete=models.CASCADE, default=1)
...
class CartProduct(models.Model):
    ...
    parent = models.ForeignKey(Cart, verbose_name='Корзина', on_delete=models.CASCADE)
